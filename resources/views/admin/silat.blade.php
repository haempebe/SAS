                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="pelatih" value="{{ old('pelatih') }}" autocomplete="off">
                            @error('pelatih')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="materi" value="{{ old('materi') }}" autocomplete="off">
                            @error('materi')
                                <p class='text-danger mb-0 text-xs pt-1'> {{ $message }} </p>
                            @enderror
                        </div>
