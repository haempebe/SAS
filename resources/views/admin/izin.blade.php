                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <select class="form-select" name="jenis_izin">
                            ...
                            <option value="Perjalanan Dinas" @if ($item->jenis_izin == 'Perjalanan Dinas') selected @endif>Perjalanan Dinas
                            </option>
                        </select>
                        @error('jenis_izin')
                        <p class='text-danger mb-0 text-xs pt-1'> {{ $message }}
                    ...
                    <div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label class="form-label">Jam Mulai</label>
                                    <input type="dateTime" name="jam_mulai" class="form-control" data-mask="00:00" data-mask-visible="true" placeholder="00:00" autocomplete="off" fdprocessedid="ms68ld" value="{{$item->jam_mulai}}">
                                    @error('jam_mulai')
                                    <p class='text-danger mb-0 text-xs pt-1'> {{ $message }} </p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <label class="form-label">Jam Berakhir</label>
                                <input type="text" name="jam_berakhir" class="form-control" data-mask="00:00" data-mask-visible="true" placeholder="00:00" autocomplete="off" fdprocessedid="ms68ld" value="{{$item->jam_berakhir}}">
                                @error('jam_berakhir')
                                <p class='text-danger mb-0 text-xs pt-1'> {{ $message }} </p>
                                @enderror
                            </div>
