                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="row g-0">
                                    <div class="col">
                                        <button href="#" class="btn btn-success btn-icon" data-bs-toggle="modal" data-bs-target="#modal-update-{{ $item->id }}">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-center py-5">
                                            ...
                                            <div class="row justify-content-center mt-5">
                                                ...
                                                <div class="col-3">
                                                    <a href="#" data-bs-dismiss="modal" class="btn btn-outline-primary w-100">
                                                        TIDAK
                                                    </a>
                                                </div>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="dateTime" name="jam_mulai" class="form-control" data-mask="00:00" data-mask-visible="true" placeholder="00:00" autocomplete="off" fdprocessedid="ms68ld" value="{{ trim(\Carbon\Carbon::parse(request()->jam_mulai)->format('H:i')) }}">
                                    @error('jam_mulai')
                                    <p class='text-danger mb-0 text-xs pt-1'> {{ $message }} </p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="jam_berakhir" class="form-control" data-mask="00:00" data-mask-visible="true" placeholder="00:00" autocomplete="off" fdprocessedid="ms68ld" value="{{ old('jam_berakhir') }}">
                                @error('jam_berakhir')
                                <p class='text-danger mb-0 text-xs pt-1'> {{ $message }} </p>
                                @enderror
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-selectgroup-boxes row mb-3">
                        <div class="col-lg-6">
                            <label class="form-selectgroup-item">
                                <input type="radio" name="role" value="Tendik" class="form-selectgroup-input" @if ($item->role == 'Tendik') checked @endif>
                                <span class="form-selectgroup-label d-flex align-items-center p-3">
                                    <span class="me-3">
                                        <span class="form-selectgroup-check"></span>
                                    </span>
                        ...
                        <div class="col-lg-6">
                            <label class="form-selectgroup-item">
                                <input type="radio" name="role" value="Siswa" class="form-selectgroup-input" @if ($item->role == 'Siswa') checked @endif>
                                <span class="form-selectgroup-label d-flex align-items-center p-3">
                                    <span class="me-3">
                                        <span class="form-selectgroup-check"></span>
                                    </span>
