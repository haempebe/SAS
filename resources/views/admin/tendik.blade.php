 ...
 @section('content')
                                     ...
                                     <tr>
                                         ...
                                         <td class="text-end">
                                             <div class="row g-0">
                                                 ...
                                                 <div class="col">
                                                     <form action="{{ route('tendik.delete', $item->id) }}"
                                                         method="POST">
                                                         @csrf
                                                         @method('DELETE')
     ...
     {{-- Form Create --}}
     <div class="modal modal-blur fade {{ session('errors') ? 'show' : '' }}" id="modal-create" tabindex="-1"
         role="dialog" aria-hidden="true" style="{{ session('errors') ? 'display: block;' : 'display: none;' }}">
