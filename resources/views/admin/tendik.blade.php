                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex py-1 align-items-center">
                                    ...
                                    <div class="flex-fill">
                                        ...
                                        <div class="text-secondary"><a href="#" class="text-reset">mail@gmail.com</a>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="text-end">
                                <div class="row g-0">
                                    <div class="col">
                                        <button href="#" class="btn btn-success btn-icon" data-bs-toggle="modal"
...
{{-- Form Create --}}
<div class="modal modal-blur fade {{ session('errors') ? 'show' : '' }}" id="modal-create" tabindex="-1" role="dialog"
    aria-hidden="true" style="{{ session('errors') ? 'display: block;' : 'display: none;' }}">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input accept="image/*" type="file" class="form-control" name="foto" onchange="previewImage()"
                        value="{{ old('foto') }}">
                    @error('foto')
                    <p class='text-danger mb-0 text-xs pt-1'> {{ $message }} </p>
                    @enderror
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="jam_masuk" class="form-control" data-mask="00:00"
                                        data-mask-visible="true" placeholder="00:00" autocomplete="off"
                                        fdprocessedid="ms68ld" value="{{ $item->jam_masuk }}">
                                    @error('jam_masuk')
                                    <p class='text-danger mb-0 text-xs pt-1'> {{ $message }} </p>
                                    @enderror
                                </div>
...
@section('form-class')
{{ session('errors') ? 'modal-open' : '' }}
@endsection

@section('form-style')
{{ session('errors') ? 'overflow: hidden; padding-right: 0px;' : '' }}
@endsection