...
@section('content')
    <div class="page-wrapper">
        <div class="container">
            ...
            <form action="/filter-tendik" method="GET">
                <div class="row g-2">
                    <div class="col-5">
                        <div class="input-icon mb-3">
                            <input class="form-control" name="start_date"
                                placeholder="{{ str_contains(request()->url(), 'filter-tendik') == true ? $start_date : '' }}"
                    ...
                    <div class="col-5">
                        <div class="input-icon mb-3">
                            <input class="form-control" name="end_date"
                                placeholder="{{ str_contains(request()->url(), 'filter-tendik') == true ? Str::limit($end_date, 10, '') : '' }}"
